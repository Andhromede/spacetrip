...
const Booking = () => {
   ...
   return (
      <>
         {/* {booking && */}
         <div className="pb-16">
            <div name="name" className="mx-auto tracking-wider text-2xl text-primary font-Starjedi text-center" id="name">{values.name.toLowerCase()}</div>
                              ...
                              <div className="grid grid-cols-12">
                                 ...
                                 <div className="col-span-4 ">
                                    ...
                                    <Field as='select' id="status" name="status" className="w-full bg-[#202020] rounded-lg mt-5">
                                       <option key="payé" value="payé" selected={values.status === status}>payé</option>
                                       <option key="panier" value="panier" selected={values.status === status}>panier</option>
                                       <option key="validé" value="validé" selected={values.status === status}>validé</option>
                                       <option key="annulé" value="annulé" selected={values.status === status}>annulé</option>
                                       <option key="en attente" value="en attente" selected={values.status === status}>en attente</option>
